...
javac -d build\classes src\retailershopmanagmentsystem\EncoderAndDecoder.java
javac -d build\classes src\Beans\*.java
javac -d build\classes src\databaseManager\*.java
javac -d build\classes src\FronterFrame\*.java
javac -d build\classes src\Recipte\*.java
javac -d build\classes src\retailershopmanagmentsystem\*.java
